...
Serving countries all over the world, the Peace Corps lives up to its promise as 'the toughest job you'll ever love.' Volunteers do everything from teaching English to sharing tips on growing food to providing preventive health care. However, the application process to become a Peace Corps volunteer is very competitive. You must be a US citizen, at least eighteen years old, in good health, and willing to serve for two years. Nearly all volunteers have a bachelor's degree in their chosen field, and about 18 percent have their master's or doctorate degrees. Knowing a language, especially French and Spanish, helps."
	,vi:"Vào ngày 1 tháng 3 năm 1961, Tổng thống John F. Kennedy đã ban hành lệnh thành lập Đoàn Hòa bình. Sứ mệnh của đoàn là thúc đẩy hòa bình và tình hữu nghị thế giới bằng cách cung cấp các tình nguyện viên đủ tiêu chuẩn đến các quốc gia quan tâm. Ngày nay, đoàn gửi trung bình 6000 công dân Hoa Kỳ ra nước ngoài mỗi năm.<br>\
...
The collector is covered with glass or plastic. This layer allows short-wave radiation - or light - to enter the collector. A5 the radiation passes through the glass or plastic, it is transformed from short-wave radiation to long-wave radiation- or heat. Long-wave radiation cannot pass through the glass or plastic back into the atmosphere. Therefore, the heat is trapped within the collector. Collectors are usually placed at an angle to maximise the amount of radiation falling on them.<br>\
A transfer agent (air or water) is circulated through the collector and becomes heated. A5 it leaves the collector and travels through the heating ducts of a house, it warms the air inside the house or brings hot water to sinks, tubs, and appliances. With solar collectors, storage is a problem: great amounts of heat must be stored for nighttime use and for use during cloudy days."
	,vi:"Bộ thu nhiệt mặt trời hấp thụ nhiệt từ tia nắng mặt trời. Chúng có thể được sử dụng để sưởi ấm và làm mát các tòa nhà một cách hiệu quả. Loại bộ thu nhiệt phổ biến nhất để sưởi ấm không gian là tấm phẳng được thiết kế để hấp thụ cả bức xạ chiếu trực tiếp vào nó cũng như bức xạ bị khí quyển phân tán.<br>\
...
<br>\
If your library is large enough, it may have film equipment that you may borrow. To do so, however, the library usually requires a separate registration. You may also have to take and pass a course the library gives on how to operate the different pieces of equipment.<br>\
<br>\
You usually check out and return borrowed materials at the same desk. The sign on this desk may read Circulation Desk, Check Out Here, or perhaps Charge Desk. The library staff member at this desk will take your card and stamp the book card with a date. This is the date by which you are expected to return the material to the library, so others can have the chance of borrowing it. Many libraries allow you to renew the book if it has not been requested by others.<br>\
<br>\
Some libraries charge a fine for each day a library book is overdue, kept out beyond the date stamped on the book card. There are also often fines for books returned damaged or written in. Should you lose a library book, you may be required to pay the library the amount it was worth. Not paying fines could result in your losing all library privileges."
	,vi:"Hầu hết các thư viện yêu cầu bạn phải đăng ký trước khi được phép mượn bất kỳ tài liệu nào của họ. Điều này có nghĩa là bạn có thể sẽ được yêu cầu điền và ký vào thẻ đăng ký. Khi bạn làm điều này, bạn không chỉ cung cấp cho thư viện tên và địa chỉ của bạn để lưu trữ hồ sơ của họ mà còn ký vào một thỏa thuận. Về cơ bản, thỏa thuận nêu rõ rằng bạn sẽ tuân thủ các quy tắc của thư viện. Đôi khi, cha mẹ hoặc người giám hộ cũng được yêu cầu ký vào thẻ.<br>\
<br>\
Để được phép sử dụng thư viện trường học của mình, có lẽ bạn chỉ phải đăng ký vào trường đó. Sau khi đăng ký, bạn sẽ được cấp thẻ thư viện hoặc thẻ người mượn. Trên thẻ này sẽ có tên và số của bạn. Mỗi lần bạn trả phòng, tức là chính thức mượn thứ gì đó từ thư viện, bạn sẽ phải xuất trình thẻ này cho thủ thư.<br>\
<br>\
Nếu thư viện của bạn đủ lớn, có thể có thiết bị phim mà bạn có thể mượn. Tuy nhiên, để làm như vậy, thư viện thường yêu cầu phải đăng ký riêng. Bạn cũng có thể phải tham gia và vượt qua khóa học mà thư viện cung cấp về cách vận hành các thiết bị khác nhau.<br>\
<br>\
Bạn thường kiểm tra và trả lại tài liệu đã mượn tại cùng một quầy. Biển báo trên quầy này có thể ghi là Quầy lưu thông, Kiểm tra tại đây hoặc có thể là Quầy tính tiền. Nhân viên thư viện tại quầy này sẽ lấy thẻ của bạn và đóng dấu ngày vào thẻ sách. Đây là ngày bạn phải trả lại tài liệu cho thư viện để những người khác có thể mượn. Nhiều thư viện cho phép bạn gia hạn sách nếu người khác không yêu cầu.<br>\
<br>\
Một số thư viện tính tiền phạt cho mỗi ngày trả sách quá hạn, giữ lại quá ngày đóng dấu trên thẻ sách. Ngoài ra, thường có tiền phạt đối với những cuốn sách trả lại bị hư hỏng hoặc bị viết đè. Nếu bạn làm mất sách thư viện, bạn có thể phải trả cho thư viện số tiền tương đương với giá trị của sách. Không trả tiền phạt có thể khiến bạn mất tất cả các quyền lợi của thư viện."
	,voca:"",
},
{
...
<br>\
[C] When faced with a stressful event, people with the cancer-prone personality do not show stress outwardly. Instead, they keep their emotions bottled inside. They repress, or hide, their emotions, even from themselves.<br>\
<br>\
[D] The cancer-prone personality is linked to the likelihood of getting cancer, and the same personality traits seem to help affect a cancer victim's recovery. For example, some studies have looked at cancer patients who accept the cancer without getting angry. These patients get sick faster and they die sooner than people who became angry at their cancer and fight the disease."
	,vi:"[A] Một trong những lý do khiến các nhà khoa học nghĩ rằng có mối liên hệ giữa căng thẳng và ung thư là ý tưởng rằng có thể có một tính cách dễ mắc ung thư. Tính cách dễ mắc ung thư bao gồm một tập hợp các đặc điểm tính cách thường thấy ở những người mắc ung thư hơn là những người không mắc ung thư.<br>\
<br>\
[B] Những đặc điểm tính cách nào tạo nên tính cách dễ mắc ung thư? Thông thường, những người lịch sự, không hung hăng và dễ chịu được cho là có loại tính cách này. Họ dường như gặp khó khăn trong việc thể hiện khi họ tức giận. Ngay cả trong những tình huống mà họ nên tức giận, họ vẫn tỏ ra bình tĩnh và vui vẻ.<br>\
<br>\
...
The threats to our environment are all related. For instance, building cycleways instead of unnecessary new roads would save energy and reduce pollution and the destruction of our wildlife."
	,vi:"Friends of the Earth Trust là một tổ chức từ thiện giáo dục được thành lập để giúp mọi người ở mọi lứa tuổi nhận thức được các mối đe dọa đối với môi trường của chúng ta. Ô nhiễm chỉ là một trong số đó. Việc phá hủy động vật hoang dã và lãng phí tài nguyên thiên nhiên của chúng ta là những mối đe dọa khác.<br>\
Ở Anh, vùng nông thôn đang biến mất hoặc bị phá hủy - nông nghiệp hiện đại, khai thác mỏ, đường dành cho xe máy và nhà máy điện đều góp phần vào sự tàn phá này. Đến năm 2010, khoảng một nửa số loài động vật và thực vật trên thế giới có thể bị tuyệt chủng.<br>\
Mỗi năm, một khu rừng có kích thước bằng xứ Wales bị chặt phá để sản xuất giấy sử dụng ở Anh. Nếu nhiều người sử dụng giấy tái chế hơn, sẽ có ít cây bị chặt phá hơn và sẽ có ít chất thải hơn để xử lý. Một lợi ích quan trọng khác là việc thu gom giấy thải sẽ tạo ra nhiều việc làm mới.<br>\
...
The report predicted, among other things, that 'between half a million and 2 million species -15 to 20 percent of all species on earth-could be extinguished by the year 2000'. It warned of more hardship for the Earth's human inhabitants as well-more starvation, for example.<br>\
This report strongly urged the government to take immediate action. It gave recommenda tions for change. But by the time the study was completed, Ronald Reagan had been elected president and his administration ignored the report.<br>\
The 1980s were not a good decade for the environment. It is likely that a global report now would be even bleaker than the one published after the 1970s. Many environmentalists wonder if we can stop the destruction of our planet before it is too late. When, they ask, will humans realise that they are not meant to be masters of the Earth, only one of its guests?"
	,vi:"Đôi khi con người giết động vật gián tiếp. Rất ít nơi trên hành tinh này không bị con người xâm phạm. Dân số loài người ngày càng tăng cần nhiều không gian hơn. Các ngành công nghiệp sử dụng ngày càng nhiều tài nguyên thiên nhiên của Trái đất. Kết quả là: trong vòng chưa đầy một trăm năm, có tới hai trăm loài chim và động vật có vú đã biết đã biến mất.<br>\
Tại sao? Nhiều môi trường sống tự nhiên đang biến mất. Các khu rừng nhiệt đới của Trái đất đang bị phá hủy, cùng với cư dân của chúng. Chất thải độc hại, ô nhiễm không khí và bức xạ gây ra hậu quả khủng khiếp cho động vật hoang dã. Những thay đổi trong tầng ôzôn của hành tinh và khí hậu đe dọa tất cả các loài động vật, bao gồm cả con người.<br>\
Năm 1977, Tổng thống Jimmy Carter đã yêu cầu một nghiên cứu chính thức về môi trường. Ông hỏi, hành tinh của chúng ta sẽ như thế nào vào năm 2000 nếu xu hướng hiện tại tiếp tục? Nghiên cứu này được thực hiện bởi một số bộ phận của chính phủ Hoa Kỳ theo chỉ đạo của Tiến sĩ Gerald Barney. Được công bố vào năm 1980, Báo cáo Toàn cầu 2000 gửi Tổng thống đã đưa ra những cảnh báo và dự đoán đáng kinh ngạc về số phận của Trái đất nếu chúng ta không thay đổi cách chúng ta đối xử với nó.<br>\
...
Stress, then, can be caused by both negative and positive events, or stressors. Of course, whether an event is thought of as positive or negative is, in some ways, a matter of personal choice.<br>\
In sum, it is the way people interpret an event that makes it stressful or not stressful. This process of interpretation is called appraisal. Depending on how people appraise, or judge, circumstances, they may or may not consider them stressful.<br>\
What, specifically, causes people to appraise a situation as stressful? The answer depends on how much of a threat or challenge it appears to be. Circumstances that bring a threat or challenge to a person's sense of well-being produce stress. Those that do not threaten or challenge us are not stressful.<br>\
Looking at stress this way gives us a general definition of the concept of stress: Stress is a response to circumstances that seem threatening or challenging.<br>\
The circumstances that cause stress vary from one person to another. It all depends on how we appraise circumstances. In addition, the things that cause us stress today may not cause us stress at another time. And the opposite is true: things that once caused no stress may now be stressful."
	,vi:"Hầu hết mọi người đều nói rằng họ biết căng thẳng là gì. Nhưng đối với các nhà khoa học nghiên cứu về căng thẳng, việc định nghĩa nó lại vô cùng khó khăn. Lý do là vì có quá nhiều cách để nhìn nhận về căng thẳng. <br>\
Một số nhà nghiên cứu đã nghiên cứu cách cơ thể chúng ta phản ứng với căng thẳng. Bạn biết tim mình đập nhanh hơn, đổ mồ hôi nhiều hơn và lời nói của bạn không được thốt ra đúng khi bạn rơi vào tình huống căng thẳng. Nhưng việc biết chúng ta cảm thấy thế nào khi trải qua căng thẳng không giải thích được điều đó; cũng không cho chúng ta biết nguyên nhân gây ra căng thẳng.<br>\
Các nhà khoa học khác đã nghiên cứu các tác nhân gây căng thẳng: các sự kiện hoặc tình huống gây ra căng thẳng. Một điểm dừng, kết quả kiểm tra kém hoặc tiếng ồn khó chịu đều có thể được coi là tác nhân gây căng thẳng. Ngay cả ~ các sự kiện dễ chịu cũng có thể là tác nhân gây căng thẳng. Lên kế hoạch cho một bữa tiệc hoặc bắt đầu một công việc mới cũng có thể gây căng thẳng như việc bị gọi lên phòng hiệu trưởng.<br>\
Do đó, căng thẳng có thể do cả các sự kiện tiêu cực và tích cực hoặc tác nhân gây căng thẳng gây ra. Tất nhiên, việc một sự kiện được coi là tích cực hay tiêu cực, theo một số cách, là vấn đề lựa chọn cá nhân.<br>\
Tóm lại, cách mọi người diễn giải một sự kiện khiến sự kiện đó trở nên căng thẳng hay không căng thẳng. Quá trình diễn giải này được gọi là đánh giá. Tùy thuộc vào cách mọi người đánh giá hoặc phán đoán hoàn cảnh, họ có thể coi chúng là căng thẳng hoặc không.<br>\
...
Nếu có thể, nên ngăn ngừa cháy nắng bằng cách tránh tiếp xúc lâu với ánh nắng mặt trời và che chắn các vùng hở một cách đầy đủ. Có thể điều trị bằng kem calamine và aspirin hòa tan để giảm đau."
	...
	unit:"7",
	en:"It seems as if every time you turn on the television news, you hear one or the other of the following catchphrases of the 1990s: global warming, greenhouse effect, climate change. As it often is with catchphrases, hardly anyone knows what these terms really mean or how they relate to each other.<br>\
In the past 100 years, in our effort to make the Earth a more civilised place, industrial pro duction has increased by fifty times. Four fifths of that growth has come since 1950. This production -most of it based on the burning of wood, and of fossil fuels like coal, oil, and natural gas -has greatly increased the amount of carbon dioxide in the atmosphere. When fossil fuels are burned, they release carbon into the air in the form of carbon dioxide. Carbon dioxide allows heat that would normally escape from the Earth's atmosphere to remain trapped, as it would in a greenhouse -thus the greenhouse effect.<br>\
When do you burn fossil fuels? When you turn on a light, or run an air conditioner, or take a hot shower, or make toast, you contribute to the greenhouse effect. It is a by-product of the use of energy-electricity, gasoline, or oil.<br>\
...
16. Carbon dioxide causes more problems than the other greenhouse gases do."
	...
	,en:"About University of Western Sydney Macarthur <br>\
University of Western Sydney Macarthur has two campuses, one located in the city of Camp belltown, the other in the city of Bankstown. Campbelltown is a city within the southwestern suburbs of the Sydney metropolitan area, and is 50 minutes by train from the Sydney Central Business District. Bankstown is a city within the Sydney metropolitan area, and it is 25 minutes by train from the Sydney Central Business District.<br>\
University ofWestern Sydney Macarthur is a member of University ofWestern Sydney with UWS Hawkesbury and UWS Nepean. Total enrolment in 2008 exceeded 27,000 including 2,000 international students. UWS Macarthur has over 10,000 students including 500 inter national students.<br>\
University ofWestern Sydney Macarthur's courses are taught through its six faculties: Arts & Social Sciences (at Campbelltown and Bankstown); Business (at Campbelltown); Education & Languages (mainly at Bankstown); Health (at Campbelltown and Bankstown); Informatics, Science & Technology (at Campbelltown); and Law (at Campbelltown).<br>\
<br>\
Courses Offered in 2008/2009 <br>\
Courses available to international students in 2008/2009 are listed in this booklet. All courses are full-time. Fees indicated are annual and include tuition for a standard full-time load, and the other University charges (except for English course fees). Extra fees are charged for repeating sub jects and attempting subjects in Summer Term. Fees remain constant for the normal duration of a programme. Some courses listed have a fourth year for an Honours degree. Entry is on merits and application may be made by graduates ofUWS Macarthur or graduates of other institutions. You should contact Office of International Programmes for further details on the Honours degrees available.<br>\
<br>\
Admission Requirements for Bachelor's Degree Courses <br>\
Admission into Bachelor's degrees usually requires satisfactory completion of the final year of secondary education, or equivalent qualifications. Mature age students who do not meet these requirements will still be considered on the basis of other qualifications and/or work experience. <br>\
<br>\
...
Applicants must have clearly demonstrated proficiency in English either by achieving, for example, 570 in TOEFL or 6,0 in IELTS, or by providing evidence of studies in English at a school or university which has English as the language of instruction and is deemed satisfactory by UWS Macarthur. A higher level of English is required for some programmes. English courses are available through the Macarthur English Language Centre at the Campbelltown campus."
	,vi:"Giới thiệu về Đại học Western Sydney Macarthur <br>\
Đại học Western Sydney Macarthur có hai cơ sở, một cơ sở nằm tại thành phố Camp belltown, cơ sở còn lại nằm tại thành phố Bankstown. Campbelltown là một thành phố nằm trong vùng ngoại ô phía tây nam của khu vực đô thị Sydney và cách Khu thương mại trung tâm Sydney 50 phút đi tàu. Bankstown là một thành phố nằm trong khu vực đô thị Sydney và cách Khu thương mại trung tâm Sydney 25 phút đi tàu.<br>\
Đại học Western Sydney Macarthur là thành viên của Đại học Western Sydney với UWS Hawkesbury và UWS Nepean. Tổng số sinh viên ghi danh vào năm 2008 vượt quá 27000, trong đó có 2000 sinh viên quốc tế. UWS Macarthur có hơn 10000 sinh viên, trong đó có 500 sinh viên quốc tế.<br>\
Các khóa học của Đại học Western Sydney Macarthur được giảng dạy thông qua sáu khoa: Nghệ thuật & Khoa học xã hội (tại Campbelltown và Bankstown); Kinh doanh (tại Campbelltown); Giáo dục & Ngôn ngữ (chủ yếu tại Bankstown); Y tế (tại Campbelltown và Bankstown); Tin học, Khoa học & Công nghệ (tại Campbelltown); và Luật (tại Campbelltown).<br>\
<br>\
Các khóa học được cung cấp trong năm 2008/2009 <br>\
Các khóa học dành cho sinh viên quốc tế trong năm 2008/2009 được liệt kê trong tập sách này. Tất cả các khóa học đều là toàn thời gian. Học phí được nêu là học phí hàng năm và bao gồm học phí cho khối lượng học toàn thời gian tiêu chuẩn và các khoản phí khác của trường (trừ học phí khóa tiếng Anh). Học phí bổ sung được tính cho các môn học lặp lại và các môn học cố định trong Học kỳ hè. Học phí không đổi trong suốt thời gian học thông thường của chương trình. Một số khóa học được liệt kê có năm thứ tư để lấy bằng Danh dự. Việc tuyển sinh dựa trên thành tích và sinh viên tốt nghiệp UWS Macarthur hoặc sinh viên tốt nghiệp các trường khác có thể nộp đơn. Bạn nên liên hệ với Văn phòng Chương trình Quốc tế để biết thêm thông tin chi tiết về các bằng danh dự có sẵn.<br>\
<br>\
Yêu cầu tuyển sinh đối với các khóa học cấp bằng Cử nhân <br>\
Để được tuyển sinh vào các bằng Cử nhân, thông thường bạn phải hoàn thành năm cuối trung học phổ thông hoặc các bằng cấp tương đương. Những sinh viên đã trưởng thành không đáp ứng các yêu cầu này vẫn sẽ được xem xét dựa trên các bằng cấp khác và/hoặc kinh nghiệm làm việc. <br>\
<br>\
...
Khiếu nại - Không có gì lạ khi một thứ gì đó có thể không hoạt động bình thường trong căn hộ của bạn. Chắc chắn điều đó đã xảy ra ở bất cứ nơi nào bạn từng sống trước đây. Nếu một thiết bị không hoạt động, vòi nước bị rò rỉ, vvv, hãy nêu vấn đề bằng văn bản và gửi cho người quản lý hoặc người trông coi của bạn.<br>\
...
The field of health geography is often overlooked, but it constitutes a huge area of need in the fields of geography and healthcare. If we can understand how geography affects our health no matter where in the world we are located, we can better treat disease, prevent illness, and keep people safe and well."
	,vi:"A <br>\
Mặc dù nhiều căn bệnh ảnh hưởng đến con người đã được xóa bỏ nhờ những cải thiện trong tiêm chủng và sự sẵn có của dịch vụ chăm sóc sức khỏe, nhưng vẫn còn những khu vực trên thế giới mà một số vấn đề sức khỏe phổ biến hơn. Trong một thế giới toàn cầu hóa hơn bao giờ hết, mọi người tiếp xúc với nhau thông qua việc đi lại và sống gần nhau hơn. Do đó, siêu vi-rút và các bệnh nhiễm trùng khác kháng thuốc kháng sinh ngày càng trở nên phổ biến hơn.<br>\
B <br>\
Địa lý thường có thể đóng vai trò rất lớn trong các mối quan tâm về sức khỏe của một số nhóm dân số nhất định. Ví dụ, tùy thuộc vào nơi bạn sống, bạn sẽ không có cùng mối quan tâm về sức khỏe như những người sống ở một khu vực địa lý khác. Có lẽ một trong những ví dụ rõ ràng nhất về ý tưởng này là các khu vực dễ mắc bệnh sốt rét, thường là các vùng nhiệt đới tạo ra môi trường ấm áp và ẩm ướt, nơi muỗi có thể gây ra căn bệnh này cho con người có thể sinh sôi. Ví dụ, sốt rét ít là vấn đề hơn nhiều ở các sa mạc trên cao.<br>\
C <br>\
Ở một số quốc gia, các yếu tố địa lý ảnh hưởng đến sức khỏe và hạnh phúc của người dân theo những cách rất rõ ràng. Ở nhiều thành phố lớn, gió không đủ mạnh để thổi bay lượng lớn khói bụi và ô nhiễm gây ra bệnh hen suyễn, các vấn đề về phổi, thị lực và nhiều vấn đề khác ở những người sống ở đó. Một phần của vấn đề tất nhiên là số lượng lớn ô tô đang được điều khiển, bên cạnh các nhà máy chạy bằng năng lượng than. Quá trình công nghiệp hóa nhanh chóng của một số quốc gia trong những năm gần đây cũng dẫn đến việc chặt phá rừng để mở rộng các thành phố lớn, khiến việc chống ô nhiễm bằng không khí trong lành do thực vật tạo ra càng trở nên khó khăn hơn.<br>\
D <br>\
Trong những tình huống như thế này, lĩnh vực địa lý sức khỏe mới phát huy tác dụng. Đây là một lĩnh vực nghiên cứu ngày càng quan trọng trong một thế giới mà các bệnh như bại liệt đang tái phát, các bệnh về đường hô hấp tiếp tục lây lan và các khu vực dễ mắc bệnh sốt rét vẫn đang đấu tranh để tìm ra phương pháp chữa trị tốt hơn. Địa lý sức khỏe là sự kết hợp giữa kiến ​​thức về địa lý và các phương pháp được sử dụng để phân tích và diễn giải thông tin địa lý, và mặt khác là nghiên cứu về sức khỏe, bệnh tật và các hoạt động chăm sóc sức khỏe trên toàn thế giới. Mục đích của khoa học kết hợp này là tạo ra các giải pháp cho các vấn đề sức khỏe phổ biến dựa trên địa lý. Mặc dù con người luôn dễ mắc bệnh, nhưng việc nghiên cứu cách địa lý ảnh hưởng đến sức khỏe của chúng ta có thể dẫn đến việc xóa bỏ một số bệnh nhất định và ngăn ngừa các bệnh khác trong tương lai. Bằng cách hiểu lý do và cách chúng ta bị bệnh, chúng ta có thể thay đổi cách chúng ta điều trị bệnh tật và các bệnh cụ thể ở một số vị trí địa lý nhất định.<br>\
E <br>\
Địa lý bệnh tật và tình trạng sức khỏe kém phân tích tần suất xuất hiện của một số bệnh nhất định ở các khu vực khác nhau trên thế giới và chồng dữ liệu lên địa lý của khu vực để xem liệu có mối tương quan giữa hai yếu tố này hay không. Các nhà địa lý sức khỏe cũng nghiên cứu các yếu tố có thể khiến một số cá nhân hoặc một nhóm dân số có nhiều khả năng mắc bệnh hoặc vấn đề sức khỏe cụ thể hơn so với nhóm dân số ở một khu vực khác. Các nhà địa lý y tế trong lĩnh vực này thường được đào tạo như những nhân viên y tế và có hiểu biết về dịch tễ học cơ bản liên quan đến sự lây lan của bệnh tật trong cộng đồng.<br>\
F <br>\
Các nhà nghiên cứu nghiên cứu sự tương tác giữa con người và môi trường của họ có thể dẫn đến bệnh tật (như bệnh hen suyễn ở những nơi có mức độ ô nhiễm cao) và làm việc để tạo ra một cách rõ ràng để phân loại bệnh tật, dịch bệnh và dịch bệnh theo quy mô địa phương và toàn cầu. Các nhà địa lý y tế có thể lập bản đồ sự lây lan của bệnh tật và cố gắng xác định lý do đằng sau sự gia tăng hoặc giảm sút của bệnh tật, khi họ làm việc để tìm cách ngăn chặn sự lây lan hoặc tái phát của bệnh tật trong các nhóm dân số dễ bị tổn thương.<br>\
G <br>\
