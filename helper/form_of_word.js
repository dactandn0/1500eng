...
const NOUN_SAME_VERBS = "approach,remain,urge,decline,attempt,decrease,influence,concern,drift,lease,compliment,exercise,poison,access,dump,mail,shelter,ache,dust,make,shock,act,dye,man,shop,address,echo,march,show,aim,email,mark,sign,alert,end,match,\
