...
{unit:1,title:"A Big Responsibility"
,en:"B: Mom, can I get a puppy? <br>\
...
B: OK, Mom. Thanks! ",
vi:"B: Mẹ ơi, con có thể nuôi một chú chó con không?<br>\
W: Không, Billy. Chăm sóc thú cưng là một trách nhiệm lớn.<br>\
B: Con hứa sẽ chăm sóc nó thật tốt, và mẹ không cần phải nhắc con làm gì cho nó đâu.<br>\
W: Chó không phải là đồ chơi để con chơi một lúc. Nó sẽ là một phần cuộc sống của chúng ta trong 10 hoặc 20 năm tới. Nó là một sinh vật sống.<br>\
B: Con hiểu mà, mẹ. Con hứa sẽ cho nó ăn mỗi sáng và dắt nó đi dạo mỗi chiều.<br>\
W: Đó là một phần trách nhiệm, nhưng còn nhiều hơn thế nữa. Nó cần có giấy phép và phải đến bác sĩ thú y để tiêm phòng. Một chú chó cũng cần có bạn đồng hành. Con không thể đi chơi với bạn bè và nhốt nó trong nhà cả ngày được.<br>\
B: Con hiểu mà, mẹ. Tôi có gần 100 đô la trong ngân hàng nên tôi có thể trả tiền giấy phép và tiêm phòng cho nó ngay bây giờ.<br>\
W: Còn có những khoản chi phí khác nữa. Thức ăn cho chó khá đắt.<br>\
B: À, tôi có công việc cắt cỏ và tôi sẽ đi giao báo.<br>\
W: Tôi nghĩ chúng ta nên thảo luận việc này với bố bạn khi ông ấy về nhà. Đây là quyết định của gia đình.<br>\
B: Được thôi, mẹ. Cảm ơn mẹ!",
voca:"responsibility,have to remind,to do things,for a while,route,mowing lawns,get,home,decision"
},
{unit:2,title:"Elephants Are Amazing"
,en:"Elephants are interesting. They are intelligent. They also have a great memory. You should always be kind to elephants. They remember everything. A woman from India told me a story. When she was a little girl, she knew of an evil elephant keeper. He often hit his elephant. He was very mean and cruel to the elephant. Then the evil keeper sold the elephant. The new keeper was a very kind man. Many years later, the evil keeper met the elephant again. The elephant remembered the evil man. He picked up a stone with his trunk and threw it at the evil man. The elephant still knew the man, even after so many years.<br>\
Elephants help each other, too. Elephants use a special sound. The sound is so low that people cannot hear it. This sound travels really far.<br>\
Groups of elephants can communicate with each other, even if they are far apart. This is very useful because it helps the elephants to find water and food. The elephants cooperate to help each other.",
vi:"Voi rất thú vị. Chúng thông minh. Chúng cũng có trí nhớ tuyệt vời. Bạn nên luôn tử tế với voi. Chúng nhớ mọi thứ. Một người phụ nữ Ấn Độ đã kể cho tôi nghe một câu chuyện. Khi còn nhỏ, bà biết về một người quản tượng voi độc ác. Ông ta thường đánh voi của mình. Ông ta rất độc ác và tàn nhẫn với voi. Sau đó, người quản tượng độc ác đã bán con voi. Người quản tượng mới là một người rất tốt bụng. Nhiều năm sau, người quản tượng độc ác đã gặp lại con voi. Con voi nhớ người đàn ông độc ác đó. Nó dùng vòi nhặt một hòn đá và ném vào người đàn ông độc ác. Con voi vẫn biết người đàn ông đó, ngay cả sau nhiều năm.<br>\
Voi cũng giúp đỡ lẫn nhau. Voi sử dụng một âm thanh đặc biệt. Âm thanh đó rất nhỏ nên con người không thể nghe thấy. Âm thanh này truyền đi rất xa.<br>\
Các đàn voi có thể giao tiếp với nhau, ngay cả khi chúng ở rất xa nhau. Điều này rất hữu ích vì nó giúp voi tìm thấy nước và thức ăn. Những con voi hợp tác để giúp đỡ lẫn nhau.",
voca:"India,evil,far apart,cooperate,cruel,trunk"
},
{unit:3,title:"Ants, Ants, Everywhere!"
,en:"G: Hello, Mrs. Wilson. How are you?<br>\
...
vi:"G: Xin chào, bà Wilson. Bà khỏe không?<br>\
W: Tôi lo lắng, Brianna. Hàng ngàn con kiến ​​đang ở khắp hiên nhà tôi!<br>\
G: Thật là một vấn đề lớn. <br>\
W: Tệ hơn nữa là tiệc sinh nhật của con gái tôi sẽ diễn ra sau vài ngày nữa và tôi muốn tổ chức ở hiên nhà.<br>\
G: Tại sao bạn không gọi một người diệt côn trùng?<br>\
W: Tôi sẽ gọi, nhưng tôi không muốn tất cả những hóa chất độc hại đó ở gần con tôi. Chúng có hại và không tốt cho sức khỏe. Tôi cũng không muốn những chất nguy hiểm đó ngấm vào vườn.<br>\
G: Tôi thường không gặp vấn đề gì với kiến ​​và tôi không sử dụng bất kỳ hóa chất nào.<br>\
W: Bí quyết của bạn là gì?<br>\
G: Vâng, kiến ​​rất khó kiểm soát, vì vậy tôi đã trồng rất nhiều cây bạc hà gần boong tàu của mình. Tôi cũng sử dụng quế và ớt cayenne. Tôi chỉ rắc chúng xung quanh những nơi tôi không muốn có kiến. Một số người đã thử và nói rằng nó có hiệu quả. Những người khác nói rằng họ cần phải thử cách khác.<br>\
W: Tôi nghĩ là đáng thử. Tôi thà dùng quế và bạc hà quanh hiên nhà còn hơn một số loại hóa chất độc hại. Hơn nữa, tôi không ngại có kiến ​​trong sân. Tôi chỉ không muốn chúng đến dự tiệc sinh nhật. Bạn có thể giúp tôi được không?<br>\
G: Rất vui được giúp bạn. Tôi có rất nhiều quế ở nhà và tôi có thể chạy đến cửa hàng để mua cây cho bạn.<br>\
W: Cảm ơn bạn, Brianna. Bạn là một người chu đáo.",
voca:"patio,exterminator,mint,cayenne pepper,sprinkle,cinnamon,hazardous,yard,thoughtful,deck"
},
{unit:4,title:"The Oil Spill"
,en:"My best friend Katy lives near a beautiful white sand beach. Her parents take us there every summer. The water is clean and refreshing. We have a lot of fun in the waves. Last year, there was an oil spill at Katy's beach. We volunteered at the beach to clean up the oil and help the birds that were caught in the spill.<br>\
...
The Amazon River is also home to many animals. Over 2000 types of fish live in the Amazon River. One kind of fish is the piranha. The piranha is a terrifying fish. A piranha grows up to 60 centimeters long. It hunts in a group. A group of piranha can kill and eat cattle in a matter of minutes. They are so efficient that only the bones are left. This fish is one of the most dangerous creatures in the Amazon River.",
vi:"Sông Amazon là một con sông kỳ thú. Nó độc đáo theo nhiều cách. Đây là con sông dài thứ hai trên thế giới. Nó dài 6500 km. Nó bắt nguồn từ dãy núi Andes. Lưu vực thoát nước của nó (khu vực đất tích tụ nước) bao phủ 40 phần trăm Nam Mỹ. Sông Amazon có nhiều con sông nhỏ cung cấp nước cho nó.<br>\
...
vi:"W: Cháu đang làm gì thế, Billy?<br>\
B: Cháu đang nghiên cứu. Cháu tìm thấy rất nhiều trang web tuyệt vời.<br>\
W: Cháu biết không, cô nghĩ cháu có thể muốn đến thư viện và xem một số cuốn sách.<br>\
B: Cháu không muốn. Mất quá nhiều thời gian, và bên cạnh đó, việc này nhanh chóng, dễ dàng và thú vị. Bài viết này sẽ hoàn thành trong chốc lát.<br>\
W: Internet rất tuyệt để tìm thông tin. Nhưng nó cũng đầy rẫy thông tin sai lệch và dối trá. Cháu không thực sự biết mình đang xem gì trừ khi cháu đang ở một trang web đáng tin cậy. Sẽ an toàn hơn nếu lấy một số cuốn sách trước rồi sau đó tìm kiếm thêm thông tin.<br>\
B: Bà ơi, cháu yêu bà, nhưng cháu nghĩ bà hơi cổ hủ. Hãy xem tất cả những thông tin tuyệt vời này! Báo cáo của cháu là về Albert Einstein. Bây giờ, theo trang web này, ông sinh năm 1979, đưa ra thuyết về họ hàng và được trao giải Nobel Vật lý năm 1922.<br>\
W: Thông tin của bạn sai rồi. Albert Einstein sinh năm 1879 và phát triển thuyết tương đối rộng. Ông đã giành giải Nobel năm 1921.<br>\
B: Chà! Điều đó có nghĩa là tất cả những thứ này đều không chính xác. Làm sao bạn biết tất cả những điều đó?<br>\
W: Hãy cùng tôi đến thư viện và tôi sẽ giúp bạn tìm những cuốn sách có những sự thật đó.<br>\
B: Cảm ơn bà. Bà thực sự là vị cứu tinh của cuộc đời!",
voca:" lies,developed,reliable,relatives,according,inaccurate,old-fashioned,recipe,flour"
},
{unit:7,title:"A New Calculator"
,en:"W: Hi. I'd like to see your calculators.<br>\
...
W: I'll take it.",
vi:"W: Xin chào. Tôi muốn xem máy tính của cô.<br>\
M: Cô có nghĩ đến một mẫu máy tính cụ thể nào không?<br>\
W: Tôi không nghĩ đến bất kỳ mẫu máy tính cụ thể nào. Tôi muốn một chiếc máy tính đơn giản để tính toán cơ bản.<br>\
M: Dùng cho mục đích cá nhân à?<br>\
W: Vâng. Tôi chỉ cần dùng để mua sắm và theo dõi hóa đơn.<br>\
M: Vâng, điều tuyệt vời là những chiếc máy tính đơn giản này rất rẻ và nhỏ. Đây là một mẫu máy tính chạy bằng năng lượng mặt trời không bao giờ cần pin. Nó cũng mỏng nữa.<br>\
W: Nó quá nhỏ. Tôi không thể đọc các con số dễ dàng.<br>\
M: Còn chiếc này thì sao? Đây là máy tính bỏ túi. Nó lớn hơn một chút. Màn hình dễ đọc hơn.<br>\
W: Vâng, tôi có thể nhìn rõ các con số hơn. Nó cũng dễ cầm hơn. Nó cũng chạy bằng năng lượng mặt trời à?<br>\
M: Vâng, đúng vậy. Nó cũng chạy bằng pin. Nó có màn hình tám chữ số. Máy tính này cũng có phím nhớ.<br>\
W: Giá bao nhiêu?<br>\
M: Chỉ năm đô la cộng thuế. Nó đi kèm với bảo hành một năm.<br>\
W: Tôi sẽ lấy nó.",
voca:"specific,warranty,digit,personal,solar,basic,replace,fancy,kit,customer"
},
{unit:8,title:"Racing Robots"
,en:"I have been interested in robots for as long as I can remember. The first thing I did when I entered high school was join the Robotech robot-making club. We get together after school every day and create our own robots. Nowadays it is very easy to find kits to build your own robot and these are what we use.<br>\
...
vi:"Tôi đã quan tâm đến robot từ khi tôi còn nhớ. Điều đầu tiên tôi làm khi vào trung học là tham gia câu lạc bộ chế tạo robot Robotech. Chúng tôi tụ tập sau giờ học mỗi ngày và tự tạo ra robot của riêng mình. Ngày nay, rất dễ tìm thấy bộ dụng cụ để chế tạo robot của riêng bạn và đây là những gì chúng tôi sử dụng.<br>\
...
Robot của chúng tôi cao khoảng 30 cm. Nó nặng hai kg. Nó sẽ thực sự nhanh. Chúng tôi đã luyện tập thường xuyên và chúng tôi đã đạt được tốc độ của năm ngoái, vì vậy chúng tôi chỉ cần nhanh hơn một chút. Chúng tôi giữ bí mật về thiết kế robot của mình. Nếu thắng, chúng tôi sẽ nhận được 500 đô la. Tôi hy vọng đây sẽ là năm may mắn của tôi.",
voca:"create,annual,design,robot,secret,highlight,maze,fine,nowadays,competition"
},
{unit:9,title:"Online Chatting"
,en:"W: Philip, are you still chatting online? It's 9:30 pm. You have an exam tomorrow.<br>\
...
vi:"W: Philip, con vẫn trò chuyện trực tuyến chứ? Bây giờ là 9:30 tối. Ngày mai con có bài kiểm tra.<br>\
B: Vâng, mẹ. Con sẽ nghỉ một lát.<br>\
W: Con đã đọc một số bài viết về trò chuyện trực tuyến. Con không chắc là con nên dành nhiều thời gian ngồi trước máy tính như vậy.<br>\
B: Mẹ, điều đó có vẻ không công bằng. Nó có thể rất bổ ích. Con gặp gỡ những người từ khắp nơi trên thế giới và họ nói về nhiều thứ khác nhau.<br>\
W: Được rồi, có thể những người này chia sẻ kiến ​​thức của họ. Con vẫn nghĩ rằng tốt hơn là tham gia các câu lạc bộ và giao lưu với những người thực sự.<br>\
B: Con có nghĩ rằng trò chuyện trực tuyến gây ra hành vi xấu không?<br>\
W: Trò chuyện trực tuyến có thể gây nghiện, chưa kể đến việc tốn kém.<br>\
B: Vâng, nếu bạn có DSL, trò chuyện không tốn kém. Ngoài ra, không phải ai trò chuyện cũng nghiện. Người khuyết tật có thể giao lưu trực tuyến tốt hơn. Bạn biết đấy, không phải mọi khu vực đều có thể tiếp cận bằng xe lăn.<br>\
...
,
{unit:12,title:"Talking Drums"
,en:"B: I want to be a member of a heavy metal band. I love heavy metal drums, James.<br>\
...
,vi:"B: Tôi muốn trở thành thành viên của một ban nhạc heavy metal. Tôi thích trống heavy metal, James.<br>\
...
{unit:15,title:"The List"
,en:"G: Thanks for coming, Dad. I can't believe my first day of school is just next week!<br>\
...
M: Great! Let's pay for all these supplies."
	,vi:"G: Cảm ơn bố đã đến. Con không thể tin là ngày đầu tiên đi học của con chỉ mới là tuần tới!<br>\
