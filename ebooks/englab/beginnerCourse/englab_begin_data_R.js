...
A transfer agent (air or water) is circulated through the collector and becomes heated. A.5 it leaves the collector and travels through the heating ducts of a house, it warms the air inside the house or brings hot water to sinks, tubs, and appliances. With solar collectors, storage is a problem: great amounts of heat must be stored for nighttime use and for use during cloudy days."
...
Bộ thu nhiệt được phủ bằng kính hoặc nhựa. Lớp này cho phép bức xạ sóng ngắn - hoặc ánh sáng - đi vào bộ thu nhiệt. A.5 bức xạ đi qua kính hoặc nhựa, nó được chuyển đổi từ bức xạ sóng ngắn thành bức xạ sóng dài - hoặc nhiệt. Bức xạ sóng dài không thể đi qua kính hoặc nhựa trở lại khí quyển. Do đó, nhiệt bị giữ lại bên trong bộ thu nhiệt. Bộ thu nhiệt thường được đặt ở một góc để tối đa hóa lượng bức xạ chiếu vào chúng.<br>\
Một tác nhân truyền (không khí hoặc nước) được lưu thông qua bộ thu nhiệt và trở nên nóng. A.5 nó rời khỏi bộ thu nhiệt và đi qua các ống dẫn nhiệt của ngôi nhà, nó làm ấm không khí bên trong ngôi nhà hoặc mang nước nóng đến bồn rửa, bồn tắm và các thiết bị. Với bộ thu nhiệt mặt trời, lưu trữ là một vấn đề: phải lưu trữ một lượng nhiệt lớn để sử dụng vào ban đêm và sử dụng vào những ngày nhiều mây."
	,voca:"",
},
{
