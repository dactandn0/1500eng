...
Vào mùa đông, có rất ít thức ăn. Những loài động vật này có thể trở nên rất gầy và yếu. Nếu chúng di chuyển quá nhiều và không ăn, chúng có thể chết. Động vật ngủ đông để tránh cái lạnh. Cũng có những loài động vật ở vùng khí hậu nóng để tránh cái nóng. Trong thời tiết rất nóng hoặc khô, chúng ngủ dưới lòng đất. Đây được gọi là aestivation."
	,voca:"hibernate,shelter,climates,weather,underground,include,crack,lizards,squirrels,aestivation,cold-blooded",
},
{
	unit:2
...
Giống như cây cối, động vật cũng cảm nhận được những thay đổi trong khí hậu mùa thu mát mẻ hơn. Động vật ngủ đông ăn rất nhiều vào mùa thu. Chúng tăng cân để dự trữ năng lượng dưới dạng chất béo. Chúng sử dụng năng lượng này để sống sót qua mùa đông trong khi ngủ đông. Nhiều loài chim sống sót qua cái lạnh theo một cách khác: chúng rời đi. Hàng năm, nhiều loài chim di cư về phía nam đến vùng khí hậu ấm hơn vào mùa thu. Chúng lại di cư về phía bắc vào mùa xuân. Không phải là một ý tưởng tồi nếu bạn hỏi tôi! Rốt cuộc, ai sẽ từ chối một chuyến đi giữa mùa đông đến Thái Lan đầy nắng?"
	,voca:"sense,survive,reveals,chlorophyll,fades,migrate,chemical",
},
{
	unit:3
	,title:"How the Dinosaurs Disappeared"
	,en:"The death of the dinosaurs is a great mystery. About 65 million years ago, dinosaurs lived all over the Earth. They had existed for nearly 200 million years. Suddenly, they all became extinct.<br>\
...
},
{
	unit:4,
	title:"Acid Rain",
	en:"M: I hate this rain. It's causing the traffic to back up for miles!<br>\
...
W: One simple thing they could do is to use less energy. Another way to stop acid rain is to drive less, or at least carpool. Imagine if every car on this road had four people in it right now. There would be fewer cars and a lot less acid rain."
	,vi:"M: Tôi ghét cơn mưa này. Nó khiến giao thông ùn tắc hàng dặm!<br>\
...
W: Một điều đơn giản mà họ có thể làm là sử dụng ít năng lượng hơn. Một cách khác để ngăn chặn mưa axit là lái xe ít hơn, hoặc ít nhất là đi chung xe. Hãy tưởng tượng nếu mỗi chiếc xe trên con đường này có bốn người ngồi ngay bây giờ. Sẽ có ít xe hơn và ít mưa axit hơn rất nhiều."
	,voca:"acid,sulfur,nitrogen,exhaust,cancer,carpool,Alzheimer's disease,fumes,effect",
},
{
	unit:5,
...
},
{
	...
	en:"W: What's so funny? I can't concentrate on my work if you keep laughing loudly like that.<br>\
...
W: Ha! Do you really think that will happen? That's completely unbelievable!"
	,vi:"W: Có gì buồn cười thế? Tôi không thể tập trung làm việc nếu bạn cứ cười lớn như thế.<br>\
...
},
{
	...
	en:"W: And now ladies and gentlemen, the moment you have all been waiting for. Here's the winner of this year's science contest: Charles Moore! Charles, tell everyone about your invention.<br>\
...
My machine does this with sound. As a sound enters the microphone, the machine determines the sound's frequency. Then it makes a sound in the opposite frequency that cancels out the first sound. I hope my machine will give some peace and quiet to people living in noisy places. Thank you."
	,vi:"W: Và bây giờ, thưa các quý ông, quý bà, khoảnh khắc mà tất cả mọi người đang chờ đợi. Đây là người chiến thắng cuộc thi khoa học năm nay: Charles Moore! Charles, hãy kể cho mọi người nghe về phát minh của bạn.<br>\
...
},
{
	...
	en:"B: Hi, Julie. I'm trying to figure out the dimensions of this MP4 player I want to buy, but I'm having trouble converting these English measurements. You're really good at mathematics, aren't you? It says that the MP4 player is 3,6 inches tall and two inches wide, but what does that mean in centimeters?<br>\
...
B: Well, now I have the same sort of problem again. Could you help me figure out how to convert Chinese currency to our currency?"
	,vi:"B: Chào Julie. Tôi đang cố gắng tính toán kích thước của máy nghe nhạc MP4 mà tôi muốn mua, nhưng tôi gặp khó khăn khi chuyển đổi các phép đo tiếng Anh này. Bạn thực sự giỏi toán, phải không? Nó nói rằng máy nghe nhạc MP4 cao 3,6 inch và rộng hai inch, nhưng điều đó có nghĩa là gì sang centimet?<br>\
...
},
{
	...
	en:"Computers have transformed the way people communicate. In some ways this transformation is good, but in other ways it could be harmful. Statistics show that millions of people use the Internet every day. People shop online, play games, and search for information. Studies also show that people use the Internet mainly for communication.<br>\
...
},
{
	...
	en:"Hi! My name is Sandy. Welcome to physics, my favorite class. Although there are 30 students in our class, only six of us are girls.<br>\
...
In school, my teachers were surprised. They were used to boys giving all the answers in science class. They were impressed with my science exam scores. I have lots of confidence in myself. I know that boys are not smarter than girls in science and math classes. I just wish I could convince my friends!"
	,vi:"Xin chào! Tên tôi là Sandy. Chào mừng đến với môn vật lý, lớp học yêu thích của tôi. Mặc dù có 30 học sinh trong lớp, nhưng chỉ có sáu người là con gái.<br>\
...
},
{
	unit:11,
	title:"On Stage!",
	en:"Love. Hate. Death. These things are at the heart of Shakespeare's famous tragedy, Romeo and Juliet. The St. Stephens High School drama club performed this play last weekend.<br>\
...
Overall, St. Stephens' production of Romeo and Juliet was a great night of high school theater."
	,vi:"Yêu. Ghét. Chết. Những điều này là cốt lõi của bi kịch nổi tiếng của Shakespeare, Romeo và Juliet. Câu lạc bộ kịch của Trường trung học St. Stephens đã biểu diễn vở kịch này vào cuối tuần trước.<br>\
...
},
{
	...
	en:"The Mona Lisa is one of the most famous paintings in the world. It was painted by the great Italian artist, Leonardo da Vinci, between the years 1503 and 1505. The portrait was done with oil paint on a simple piece of wood. The portrait shows a woman in front of a landscape with mountains. Many people believe that the model for the painting was the wife of an important man in the area. However, some people now think that da Vinci actually drew a picture of himself. They say the face looks similar to his. Apparently, da Vinci loved the painting so much that he carried it with him at all times until he sold it to the king of France.<br>\
...
},
{
	unit:15,
	title:"A Nice Gift",
	en:"W: We've been invited to Lisa and Tom's wedding in August, so we need to get them a present. Do you have any ideas about what to buy them?<br>\
...
W: That's a great idea. I think that will make a lovely wedding present."
	,vi:"W: Chúng ta được mời đến dự đám cưới của Lisa và Tom vào tháng 8, vì vậy chúng ta cần mua quà cho họ. Bạn có ý tưởng nào về việc nên mua gì cho họ không?<br>\
...
},
{
	...
	en:"G:Come on, Tony, let's go to a movie tonight.<br>\
...
G: I don't know, but it's played all over the world. There's even a rock, paper, scissors world championship that has been held every year in Europe since 1934."
	,vi:"G: Thôi nào, Tony, tối nay chúng ta đi xem phim nhé.<br>\
