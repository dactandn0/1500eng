...
,incredibly,considerably,particularly,significantly,meanwhile,somewhat,according to\
,a bit of,a sense of,a bit,a lot,a wide range of,that"

SPECIAL_WORDS = Helper_SoftStringData(SPECIAL_WORDS)

const NOUN_SAME_VERBS = "demand,feed,approach,remain,urge,decline,attempt,decrease,influence,concern,drift,lease,compliment,exercise,poison,access,dump,mail,shelter,ache,dust,make,shock,act,dye,man,shop,address,echo,march,show,aim,email,mark,sign,alert,end,match,\
